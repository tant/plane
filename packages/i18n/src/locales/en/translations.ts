export default {
  ...
  project_settings: {
    ...
    estimates: {
      ...
      edit: {
        ...
        switch: {
          title: "Switch estimate system",
          current: "Current estimate system",
          new: "New estimate system",
          select_placeholder: "Select an estimate system",
        },
      },
      toasts: {
        created: {
  ...
  project_overview: {
    ...
    milestones_description: "Start adding milestones to manage and track the progress.",
    ...
    logo_updated: "Project logo updated successfully",
    add_link: "Add link",
    attach: "Attach",
    properties: "Properties",
    state: "State",
