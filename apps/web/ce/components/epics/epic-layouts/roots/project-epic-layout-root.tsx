...
// local imports
import { EpicListLayout } from "../list/epic-list-root";
import { EpicKanBanLayout } from "../kanban/epic-kanban-root";

function ProjectEpicLayout(props: { activeLayout: EIssueLayoutTypes | undefined }) {
...
export const ProjectEpicLayoutRoot = observer(function ProjectEpicLayoutRoot() {
  // router
        ...
        {({ filter: projectWorkItemsFilter }) => (
          <div className="relative flex h-full w-full flex-col overflow-hidden">
            ...
            <div className="relative h-full w-full overflow-auto bg-surface-1">
              ...
              <ProjectEpicLayout activeLayout={activeLayout} />
            </div>
            {/* peek overview */}
            <IssuePeekOverview />
          </div>
