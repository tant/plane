...
export class ProjectEpics extends BaseIssuesStore implements IProjectEpics {
  ...
  constructor(_rootStore: IIssueRootStore, issueFilterStore: IProjectEpicsFilter) {
    // Pass EIssueServiceType.EPICS to the base class
  ...
  /**
   * This method is called to fetch the first epics of pagination
   * @param workspaceSlug
   * @param projectId
   * @param loadType
   * @param options
  ...
  /**
   * This Method exists to fetch the first page of the epics with the existing stored pagination
